...
def get_waveform(scope, ch_num):
    ...
    field_scope.write(":WAVeform:SOURce CHANnel{}".format(ch_num))
...
def get_data(filename, stripline_scope, field_scope, X_pos, Y_pos, Z_pos):
    ...
    #print(len(stripline_time1))
    #print(len(stripline_time2))
    #print(len(stripline_time3))
    #print(len(stripline_time4))
    
    #print(len(stripline_voltage1))
    #print(len(stripline_voltage2))
    #print(len(stripline_voltage3))
    #print(len(stripline_voltage4))
    
    #print(len(Xfield_time))
    #print(len(Yfield_time))
    #print(len(Zfield_time))
    
    #print(len(Xfield_voltage))
    #print(len(Yfield_voltage))
    #print(len(Zfield_voltage))
